...
namespace WDSP_GenericFunctionModule
{
    public class GenericFunctionModule
    {
        ...
        public static double VolumetricCloudTransmittance(CelestialBody sun, out string layerName, Vector3d currentPosition)
        {
            layerName = null;
            int stepCount = 500;
            //int stepCount = 50;
            ...
            Vector3d lightDirection = (sun.position - weatherDrivenSolarPanel.VesselPosition(FlightGlobals.ActiveVessel)).normalized;
            //Vector3d currentPosition = FlightGlobals.ActiveVessel.transform.position;
